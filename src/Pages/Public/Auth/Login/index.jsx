    ...
    return (
        <Box
            sx={{
                ...
                display: 'flex',
                overflow: 'hidden',  // ADDED: Prevents horizontal scroll
            }}
        >
            <Grid
                container
                sx={{
                    minHeight: '100vh',
                    margin: 0,  // CRITICAL FIX: Remove negative margin
                    width: '100%',  // CRITICAL FIX: Ensure full width
                }}
            >
                <Grid
                    size={{ xs: 12, md: 7 }}
                ...
                >
                    <Box sx={{ maxWidth: 450, width: '100%' }}>
                        ...
                        <FormControlLabel
                            ...
                            label={
                                <Typography variant="body2" sx={{ fontSize: '.875rem', color: theme.palette.text.primary }}>
                                    Remember me
                                </Typography>
                            }
                            sx={{ mb: 3 }}
