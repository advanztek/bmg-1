  ...
  const handleTakePhoto = async () => {
    ...
    try {
      ...
      if (error.name === "NotAllowedError") {
        ...
        alert(
          "Unable to access camera. Please check your device has a camera and permissions are granted.",
        );
      }
    }
  };
              ...
              >
                ...
                >
                  <TextField
                    ...
                    placeholder={
                      isTyping ? "" : services[activeService].placeholder
                    }
                    variant="outlined"
                    InputProps={{
                      startAdornment: (
                          ...
                          >
                            ...
                            >
                              ...
                              <Box sx={{ flex: 1 }}>
                                ...
                                >
                                  Click to explore • Transform your ideas into
                                  reality
                                </Typography>
                              </Box>
                            </Stack>
